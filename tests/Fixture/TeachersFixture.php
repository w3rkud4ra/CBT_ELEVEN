...
class TeachersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nip' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'FKteachers770221' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'nip' => ['type' => 'unique', 'columns' => ['nip'], 'length' => []],
            'FKteachers770221' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-01-14 15:55:03',
                'modified' => '2020-01-14 15:55:03',
                'user_id' => 1
            ],
        ];
        parent::init();
